...
import { loginUser, logoutUser, registerUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateAccountDetails, updateUserAvatar, updateUserCoverImage, getUserChannelProfile, getWatchHistory, googleAuth } from "../controllers/user.controller.js";
...
router.route("/channel/:channelId").get(getUserChannelProfile)
